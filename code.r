...
summary(model)
vif(model)
adf.test(df_monthly$Price_BTC)
adf.test(df_monthly$BTC_volume)
adf.test(df_monthly$Rate)
adf.test(df_monthly$Price_SP)
adf.test(df_monthly$Consumption)
adf.test(df_monthly$FearGreed)
dwtest(model)
bptest(model)
